...
function CookiePolicy() {
  return (
    <div className="cookie-policy-page">
      <h2>COOKIE POLICY</h2>
      <p>Our website uses cookies to give you the smoothest experience possible — from keeping the site secure to helping us understand how you interact with the content we share.</p>
